...
const cn = {
  ...
  Error: {
    Unauthorized:
      "你还未授权，请前往[设置](/#/settings)页输入正确的授权码，如果你没有授权码请进群获取：545385080，或者填入你自己的 OpenAI API Key。",
  },
  ChatItem: {
    ChatItemCount: (count: number) => `${count} 条对话`,
  },
  Chat: {
    SubTitle: (count: number) => `与 Zhang AI 的 ${count} 条对话`,
    Actions: {
      ChatList: "查看消息列表",
  ...
  Export: {
    ...
    MessageFromChatGPT: "来自 Zhang AI 的消息",
    Format: {
      Title: "导出格式",
