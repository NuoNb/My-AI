    ...
    <ErrorBoundary>
      ...
      <div className={styles["settings"]}>
          ...
          <List>
            <ListItem 
               title={"公告板"}
               subTitle={"感谢您选择使用 Zhang AI，我们是一款基于 GPT-3.5 模型的虚拟助手。作为一个无需登录、没有广告且可以在国内网络直接访问的服务，我们致力于为用户提供高效便捷的解决方案。Zhang AI 可以帮助您解决各种问题，包括但不限于语言翻译、知识查询和代码编写等任务。我们的服务完全免费，并且没有任何使用限制，因此您可以随时向我们寻求帮助。除了功能强大外，我们非常注重与用户之间的互动和反馈。如果您有任何问题或建议，请加入我们的用户反馈群（545385080），并与其他用户和开发团队进行交流。我们会定期更新和改进我们的服务，以满足您的需求和期望。最后，再次感谢您选择 Zhang AI！"}
              >
            </ListItem>
          </List>
